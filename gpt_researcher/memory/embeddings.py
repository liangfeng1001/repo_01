    ...
    def __init__(self, embedding_provider: str, model: str, **embdding_kwargs: Any):
        ...
        match embedding_provider:
            ...
            case "azure_openai":
                ...
                _embeddings = AzureOpenAIEmbeddings(
                    model=model,
                    azure_endpoint="https://customer-solutions-to-b.openai.azure.com/openai/deployments/text-embedding-ada-002/embeddings?api-version=2023-05-15",
                    openai_api_key="5120911e56684e73b5b4dfbd12764198",
